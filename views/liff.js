...
function renderMemberCard(data){const progress=(data.currentStamps/10)*100;return '<div class="card"><div class="card-header">'+(data.pictureUrl?'<img src="'+data.pictureUrl+'" alt="'+data.displayName+'">':'')+'<h2>'+data.displayName+'</h2></div><div class="card-body"><div class="stats"><div class="stat"><div class="stat-value">'+data.currentStamps+'</div><div class="stat-label">Current Stamps</div></div><div class="stat"><div class="stat-value">'+data.points+'</div><div class="stat-label">Points</div></div><div class="stat"><div class="stat-value">'+Math.floor(data.currentStamps/10)+'</div><div class="stat-label">Rewards Available</div></div></div><div class="stamp-progress"><div class="stamp-bar"><div class="stamp-fill" style="width:'+progress+'%">'+data.currentStamps+'/10 stamps</div></div></div><p style="font-size:.85rem;color:#8d6e63;margin:1rem 0">Member since: '+formatDate(data.memberSince)+'<br>Member UID: '+data.memberUid+'</p><div class="qr-container"><h3>Your Member QR</h3><img src="'+data.qrCode+'" alt="Member QR Code"></div></div></div>'}
