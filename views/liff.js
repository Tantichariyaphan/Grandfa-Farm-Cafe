...
function renderProfile(data) { return '' + '<div class="card">' + '<div class="card-header">' + (data.pictureUrl ? '<img src="' + data.pictureUrl + '" alt="' + data.displayName + '">' : '') + '<h2>' + data.displayName + '</h2>' + '</div>' + '<div class="card-body">' + '<div class="form-group">' + '<label>Phone Number</label>' + '<input id="phone" value="' + (data.phone || '') + '">' + '</div>' + '<div class="form-group">' + '<label>Birthday</label>' + '<input id="birthday" type="date" value="' + (data.birthday ? data.birthday.substring(0,10) : '') + '">' + '</div>' + '<button id="saveProfileBtn">Save Changes</button>' + '<div id="profileMessage"></div>' + '</div>' + '</div>'; }
